defmodule ExplorationsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExplorationsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExplorationsWeb.Gettext, "errors", msg, opts)
    end
  end
